...
# Mainnet Uniswap V2 router (same as tests / common fork setups).
DEFAULT_UNISWAP_V2_ROUTER = Address("0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D")
...
class PricingEngine:
    ...
    def __init__(
        ...
        *,
        ...
        self.swap_router = swap_router if swap_router is not None else DEFAULT_UNISWAP_V2_ROUTER
